...
def generate_dssp_fasta(filename_id, chain): 
    ...
    ss_string, aa_string = relevant_lines("/Users/ila/01-Unibo/02_Lab2/project_blindset/blindset_all_PDBs/150_blind_PDBs/unused_10/dsspout_unused10/pdb"+filename_id+".ent.dssp", chain)     
...
id_chain_list = ['5XJL:2', '6EHA:A', '6NTV:A', '4YWN:A', '5FLY:A', '5FLY:A']  #modified for only the 6 nachzügler

for el in id_chain_list:            # each el is like "6LTZ:A"
